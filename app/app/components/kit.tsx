...
const SOLID: Record<Accent, string> = {
  ...
  sky: "bg-sky-400 text-white hover:bg-sky-300",
  violet: "bg-violet-500 text-slate-900 hover:bg-violet-400",
  amber: "bg-amber-400 text-white hover:bg-amber-300",
  rose: "bg-rose-500 text-slate-900 hover:bg-rose-400",
  cyan: "bg-cyan-400 text-white hover:bg-cyan-300",
};

const GRADIENT: Record<Accent, string> = {
  emerald: "bg-gradient-to-r from-emerald-400 to-cyan-400 text-white hover:brightness-110",
  sky: "bg-gradient-to-r from-sky-400 to-cyan-400 text-white hover:brightness-110",
  violet: "bg-gradient-to-r from-violet-500 to-fuchsia-500 text-slate-900 hover:brightness-110",
  amber: "bg-gradient-to-r from-amber-400 to-orange-400 text-white hover:brightness-110",
  rose: "bg-gradient-to-r from-rose-500 to-pink-500 text-slate-900 hover:brightness-110",
  cyan: "bg-gradient-to-r from-cyan-400 to-emerald-400 text-white hover:brightness-110",
};
...
const ON: Record<Accent, string> = {
  ...
  violet: "bg-violet-500 text-slate-900 shadow-sm shadow-violet-500/30",
  amber: "bg-amber-400 text-white shadow-sm shadow-amber-400/30",
  rose: "bg-rose-500 text-slate-900 shadow-sm shadow-rose-500/30",
  cyan: "bg-cyan-400 text-white shadow-sm shadow-cyan-400/30",
};
