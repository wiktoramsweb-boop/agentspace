              ...
              <div className="grid gap-3 md:grid-cols-2">
                {catScenarios.map((s) => (
                  <Link
                    ...
                    className={`group relative flex items-start gap-4 overflow-hidden rounded-2xl border border-zinc-700 bg-zinc-800/40 p-5 pl-4 transition-all hover:-translate-y-0.5 hover:bg-zinc-800/70 ${style.hover}`}
                  >
