...
import { AboutPage } from "../../../components/wzory/pages/common";
...
export async function generateMetadata({ params }: { params: Promise<{ wzor: string }> }): Promise<Metadata> {
  ...
  return { title: `O nas | ${w?.office ?? "Wzór"} | wzór AgentSpace`, robots: { index: false, follow: true } };
}
