...
export function NumberScramble({
  ...
  // Start na wartości docelowej, nie na zerach: gdyby JS nie wystartował,
  // użytkownik ma zobaczyć prawdziwą liczbę, a nie "0".
  const [display, setDisplay] = useState(targetString);
